...
function LoadingSVG(props) {
    const { width = '20', height='20', text } = props;

    return (
        <>
            <svg style={{maxWidth: width, maxHeight: height, width, height}} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' preserveAspectRatio='xMidYMid'>
